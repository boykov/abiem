...
dotgsie_dir = $(shell python defaults.py dotgsie_dir)
gsie_dir = $(shell python defaults.py gsie_dir):

export PYTHONPATH := $(dotgsie_dir):$(gsie_dir):$(ahmed_dir):$(dbsym_dir):$(PYTHONPATH)
