...
class DataBase:
    ...
    def setupquad(self):
        ...
        self.quadsingular = zeros((self.orderquad_sing,2),order = 'Fortran')
        ...
        self.centres2q1 = op.j_roots(self.orderquad_sing,2,-0.5)[0]
        self.C2q1 = map(lambda y: y,
                        op.j_roots(self.orderquad_sing,2,-0.5)[1]/
                        map(lambda x: (1-x)**2*(1+x)**(-0.5),
                            op.j_roots(self.orderquad_sing,2,-0.5)[0]))
